    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="models/cavalier/index.php"><i class="la la-user"></i><span class="menu-title" data-i18n="eCommerce">Cavalier</span></a>
                </li>
                <li class=" nav-item"><a href="../hospital-menu-template" target="_blank"><i class="la la-calendar"></i><span class="menu-title" data-i18n="Hospital">Cours</span></a>
                </li>
                <li class=" nav-item"><a href="../crypto-menu-template" target="_blank"><i class="la"><img src="app-assets/images/logo/horse.png" alt=""></i><span class="menu-title" data-i18n="Crypto">Cheval</span></a>
                </li>
                <li class=" nav-item"><a href="../support-menu-template" target="_blank"><i class="la la-tag"></i><span class="menu-title" data-i18n="Support Ticket">Robe</span></a>
                </li>
                <li class=" nav-item"><a href="../travel-menu-template" target="_blank"><i class="la la-map"></i><span class="menu-title" data-i18n="Travel &amp; Booking">Pension</span></a>
                </li>
                <li class=" nav-item"><a href="../bank-menu-template" target="_blank"><i class="la la-tag"></i><span class="menu-title" data-i18n="Bank">Type Pension</span></a>
                </li>
                <li class=" nav-item"><a href="../bank-menu-template" target="_blank"><i class="la la-tag"></i><span class="menu-title" data-i18n="Bank">Inscription</span></a>
                </li>
                <li class=" nav-item"><a href="../bank-menu-template" target="_blank"><i class="la"><img src="app-assets/images/logo/tarifs.png" alt=""></i><span class="menu-title" data-i18n="Bank">Tarifs</span></a>
                </li>
