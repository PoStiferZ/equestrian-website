    ...
    var e = function () {
        ...
        return e && e.requirejs || (e ? n = e : e = {},
            ...
            o = function (e, t, n, i) {
                ...
                if (c = D(i = i || e),
                    ...
                    s = n ? n.apply(m[e], d) : void 0,
                        e && (r && r.exports !== h && r.exports !== m[e] ? m[e] = r.exports : s === h && u || (m[e] = s))
                } else
                    e && (m[e] = n)
            }
            ,
            t = n = s = function (e, t, n, i, r) {
                ...
                return t = t || function () { }
                    ...
                    "function" == typeof n && (n = i,
                        i = r),
                    i ? o(h, e, t, n) : setTimeout(function () {
                        o(h, e, t, n)
                    }, 4),
                    s
            }
            ...
            e.define("select2/results", ["jquery", "./utils"], function (h, f) {
                ...
                return f.Extend(i, f.Observable),
                    ...
                    i.prototype.option = function (e) {
                        ...
                        for (var r in (null != e.element && i.call(e.element, ":disabled") || null == e.element && e.disabled) && (delete n["aria-selected"],
            ...
            e.define("select2/selection/base", ["jquery", "../utils", "../keys"], function (n, i, r) {
                ...
                return i.Extend(o, i.Observable),
                    ...
                    n.prototype.query = function (n, i) {
                        ...
                        function e() {
                            var e = t.transport(t, function (e) {
                                ...
                                r.options.get("debug") && window.console && console.error && (t && t.results && o.isArray(t.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")),
                                    i(t)
                            }, function () {
            ...
            e.define("select2/dropdown/attachBody", ["jquery", "../utils"], function (f, a) {
                ...
                return e.prototype.bind = function (e, t, n) {
                    ...
                    e.prototype._positionDropdown = function () {
                        ...
                        f.contains(document.body, p[0]) && (h = p.offset()),
                            d.top -= h.top,
                            d.left -= h.left,
                            t || n || (i = "below"),
            ...
            e.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function (c, u, d, p, h, f, g, m, v, y, s, t, _, w, $, b, A, x, S, D, C, E, O, T, q, j, L, I, e) {
                ...
                return n.prototype.apply = function (e) {
                    if (null == (e = c.extend(!0, {}, this.defaults, e)).dataAdapter) {
                        if (null != e.ajax ? e.dataAdapter = $ : null != e.data ? e.dataAdapter = w : e.dataAdapter = _,
                            ...
                            0 < e.maximumSelectionLength && (e.dataAdapter = y.Decorate(e.dataAdapter, D)),
                    ...
                    if (null == e.resultsAdapter && (e.resultsAdapter = d,
                        ...
                        if (0 !== e.minimumResultsForSearch && (e.dropdownAdapter = y.Decorate(e.dropdownAdapter, j)),
            ...
            e.define("select2/compat/containerCss", ["jquery", "./utils"], function (s, a) {
                ...
                return e.prototype.render = function (e) {
                    ...
                    return s.isFunction(o) && (o = o(this.$element)),
            ...
            e.define("select2/compat/inputData", ["jquery", "../utils"], function (s, i) {
                ...
                return e.prototype.current = function (e, t) {
                    function i(e, t) {
                        var n = [];
                        return e.selected || -1 !== s.inArray(e.id, t) ? (e.selected = !0,
                            n.push(e)) : e.selected = !1,
            ...
            l = function (p) {
                ...
                function i(e) {
                    ...
                    if ((e = p.event.fix(n)).type = "mousewheel",
                        ...
                        if (t = Math.max(Math.abs(s), Math.abs(o)),
                            (!f || t < f) && y(n, f = t) && (f /= 40),
                            y(n, t) && (r /= 40,
                                o /= 40,
                                s /= 40),
