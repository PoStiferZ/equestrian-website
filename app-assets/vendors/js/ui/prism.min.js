                                    ...
                                    if (!(m instanceof a)) {
                                        ...
                                        if (!y && h && p != r.length - 1) {
                                            var b = r[p + 1].matchedStr || r[p + 1]
                                                , k = m + b;
                                            if (p < r.length - 2 && (k += r[p + 2].matchedStr || r[p + 2]),
                                                u.lastIndex = 0,
                                                y = u.exec(k),
                                                !y)
                                                continue;
...
!function (e) {
    ...
    for (var t = "(^([\\t ]*)):{{filter_name}}((?:\\r?\\n|\\r(?!\\n))(?:\\2[\\t ]+.+|\\s*?(?=\\r?\\n|\\r)))+", n = [{
        ...
        s = "string" == typeof s ? {
            ...
            e.languages[s.language] && (a["filter-" + s.filter] = {
...
Prism.languages.php = Prism.languages.extend("clike", {
    ...
    Prism.languages.markup && (Prism.hooks.add("before-highlight", function (e) {
        "php" === e.language && (e.tokenStack = [],
            e.backupCode = e.code,
            e.code = e.code.replace(/(?:<\?php|<\?)[\w\W]*?(?:\?>)/gi, function (a) {
...
!function () {
    ...
    function n(e, n, i) {
        for (var o, a = n.replace(/\s+/g, "").split(","), l = +e.getAttribute("data-line-offset") || 0, d = r() ? parseInt : parseFloat, c = d(getComputedStyle(e).lineHeight), s = 0; o = a[s++];) {
            ...
            h.textContent = Array(m - u + 2).join(" \n"),
                ...
                t(e, "line-numbers") || (h.setAttribute("data-start", u),
    ...
    if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
        ...
        Prism.hooks.add("complete", function (t) {
            ...
            r && a && /pre/i.test(r.nodeName) && (clearTimeout(o),
...
!function () {
    "undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function () {
        ...
        Array.prototype.forEach && Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function (t) {
            for (var a, s = t.getAttribute("data-src"), n = t, r = /\blang(?:uage)?-(?!\*)(\w+)\b/i; n && !r.test(n.className);)
                n = n.parentNode;
            if (n && (a = (t.className.match(r) || [, ""])[1]),
                !a) {
                var o = (s.match(/\.(\w+)$/) || [, ""])[1];
                a = e[o] || o
            }
            ...
            i.open("GET", s, !0),
                i.onreadystatechange = function () {
                    4 == i.readyState && (i.status < 400 && i.responseText ? (l.textContent = i.responseText,
                        Prism.highlightElement(l)) : l.textContent = i.status >= 400 ? "✖ Error " + i.status + " while fetching file: " + i.statusText : "✖ Error: File does not exist or is empty")
                }
                ,
                i.send(null)
        })
    ...
    if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        Prism.hooks.add("before-highlight", function (s) {
            ...
            if (a && /pre/i.test(a.nodeName)) {
                ...
                l && /\s*\bprism-show-language\b\s*/.test(l.className) && l.firstChild && /\s*\bprism-show-language-label\b\s*/.test(l.firstChild.className) ? i = l.firstChild : (t = document.createElement("div"),
    ...
    if ("undefined" != typeof self && self.Prism && self.document && document.createElement) {
        var e = {
            ...
            , n = function (e, a) {
                ...
                !r && a.parentNode && "pre" === a.parentNode.tagName.toLowerCase() && (r = a.parentNode.getAttribute("data-dependencies")),
                    r = r ? r.split(/\s*,\s*/g) : [],
                    i(r, function () {
                        t(e, function () {
            ...
            , t = function (a, n, t) {
                var u = function () {
                    ...
                    var i = c[a];
                    if (i || (i = c[a] = {}),
                        n && (i.success_callbacks || (i.success_callbacks = []),
                            i.success_callbacks.push(n)),
                        t && (i.error_callbacks || (i.error_callbacks = []),
...
!function () {
    "undefined" != typeof self && self.Prism && self.document && Prism.languages.markup && (Prism.plugins.UnescapedMarkup = !0,
        ...
        Prism.hooks.add("before-sanity-check", function (e) {
            if ("markup" == e.language) {
                if (e.element.matches("script[type='text/plain']")) {
                    ...
                    return n.className = t.className = e.element.className,
    ...
    "undefined" != typeof self && self.Prism && self.document && Prism.hooks.add("complete", function (e) {
        if (e.code) {
            ...
            if (t && /pre/i.test(t.nodeName) && (a.test(t.className) || a.test(e.element.className)) && !e.element.querySelector(".command-line-prompt")) {
                a.test(e.element.className) && (e.element.className = e.element.className.replace(a, "")),
                    a.test(t.className) || (t.className += " command-line");
                var n = new Array(1 + e.code.split("\n").length)
                    , s = t.getAttribute("data-prompt") || "";
                if ("" !== s)
                    n = n.join('<span data-prompt="' + s + '"></span>');
                else {
                ...
                m.className = "command-line-prompt",
                    m.innerHTML = n;
            ...
            Prism.hooks.add("before-highlight", function (e) {
                ...
                if (e.code && n && "pre" === n.nodeName.toLowerCase() && (!e.settings || e.settings["whitespace-normalization"] !== !1)) {
                    for (var t = n.childNodes, r = "", i = "", o = !1, a = Prism.plugins.NormalizeWhitespace, l = 0; l < t.length; ++l) {
                        var s = t[l];
                        s == e.element ? o = !0 : "#text" === s.nodeName && (o ? i += s.nodeValue : r += s.nodeValue,
                            n.removeChild(s),
                            --l)
                    }
...
!function () {
    "undefined" != typeof self && self.Prism && self.document && document.createRange && (Prism.plugins.KeepMarkup = !0,
        Prism.hooks.add("before-highlight", function (e) {
                ...
                var n = function (e, o) {
                    for (var t = 0, d = e.childNodes.length; d > t; t++) {
                        ...
                        if (1 === r.nodeType) {
                            ...
                            3 === r.nodeType && (!o.nodeStart && o.pos + r.data.length > o.node.posOpen && (o.nodeStart = r,
                                o.nodeStartPos = o.node.posOpen - o.pos),
                                o.nodeStart && o.pos + r.data.length >= o.node.posClose && (o.nodeEnd = r,
                                    o.nodeEndPos = o.node.posClose - o.pos),
                                o.pos += r.data.length);
                        if (o.nodeStart && o.nodeEnd) {
                            var a = document.createRange();
                            return a.setStart(o.nodeStart, o.nodeStartPos),
