    ...
    a.app.menu = {
        ...
        manualScroller: {
            ...
            update: function () {
                if (this.obj) {
                    if (!0 === a(".main-menu").data("scroll-to-active")) {
                        var e, i, s;
                        if (e = n.querySelector(".main-menu-content li.active"),
                            i = n.querySelector(".main-menu-content"),
                            t.hasClass("menu-collapsed") && a(".main-menu-content li.menu-collapsed-open").length && (e = n.querySelector(".main-menu-content li.menu-collapsed-open")),
            ...
            updateHeight: function () {
                "vertical-menu" != t.data("menu") && "vertical-menu-modern" != t.data("menu") && "vertical-overlay-menu" != t.data("menu") || !a(".main-menu").hasClass("menu-fixed") || (a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height() - a(".main-menu-header").outerHeight()),
                    this.update())
            }
        },
        init: function (e) {
        ...
        change: function (n) {
            ...
            "vertical-menu" !== s && "vertical-compact-menu" !== s && "vertical-content-menu" !== s && "vertical-menu-modern" !== s || this.toOverlayMenu(i.name, s),
                t.is(".horizontal-layout") && !t.hasClass(".horizontal-menu-demo") && (this.changeMenu(i.name),
                    a(".menu-toggle").removeClass("is-active")),
                "xl" == i.name && a('body[data-open="hover"] .dropdown').off("mouseenter").on("mouseenter", (function (e) {
                ...
                a(".header-navbar").hasClass("navbar-brand-center") && a(".header-navbar").attr("data-nav", "brand-center"),
                "sm" == i.name || "xs" == i.name ? a(".header-navbar[data-nav=brand-center]").removeClass("navbar-brand-center") : a(".header-navbar[data-nav=brand-center]").addClass("navbar-brand-center"),
        ...
        transit: function (e, n) {
            ...
            t.addClass("changing-menu"),
                e.call(i),
                t.hasClass("vertical-layout") && (t.hasClass("menu-open") || t.hasClass("menu-expanded") ? (a(".menu-toggle").addClass("is-active"),
                    "vertical-menu" !== t.data("menu") && "vertical-content-menu" !== t.data("menu") || a(".main-menu-header") && a(".main-menu-header").show()) : (a(".menu-toggle").removeClass("is-active"),
                        "vertical-menu" !== t.data("menu") && "vertical-content-menu" !== t.data("menu") || a(".main-menu-header") && a(".main-menu-header").hide())),
                setTimeout((function () {
                    n.call(i),
                        t.removeClass("changing-menu"),
                        i.update()
                }
                ), 500)
        },
        open: function () {
            this.transit((function () {
                t.removeClass("menu-hide menu-collapsed").addClass("menu-open"),
                    this.hidden = !1,
                    this.expanded = !0,
                    t.hasClass("vertical-overlay-menu") && (a(".sidenav-overlay").removeClass("d-none").addClass("d-block"),
                        t.css("overflow", "hidden"))
            }
            ), (function () {
                !a(".main-menu").hasClass("menu-native-scroll") && a(".main-menu").hasClass("menu-fixed") && (this.manualScroller.enable(),
                    a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height() - a(".main-menu-header").outerHeight())),
                    "vertical-compact-menu" != t.data("menu") || t.hasClass("vertical-overlay-menu") || (a(".sidenav-overlay").removeClass("d-block d-none"),
        ...
        hide: function () {
            this.transit((function () {
                t.removeClass("menu-open menu-expanded").addClass("menu-hide"),
                    this.hidden = !0,
                    this.expanded = !1,
                    t.hasClass("vertical-overlay-menu") && (a(".sidenav-overlay").removeClass("d-block").addClass("d-none"),
                        a("body").css("overflow", "auto"))
            }
            ), (function () {
                !a(".main-menu").hasClass("menu-native-scroll") && a(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
        ...
        expand: function () {
            !1 === this.expanded && ("vertical-menu-modern" == t.data("menu") && a(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-toggle-left").addClass("ft-toggle-right"),
                this.transit((function () {
                    ...
                    a(".main-menu").hasClass("menu-native-scroll") || "horizontal-menu" == t.data("menu") ? this.manualScroller.disable() : a(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
                        "vertical-menu" != t.data("menu") && "vertical-menu-modern" != t.data("menu") || !a(".main-menu").hasClass("menu-fixed") || a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height() - a(".main-menu-header").outerHeight())
                }
                )))
        },
        collapse: function (n) {
            !1 === this.collapsed && ("vertical-menu-modern" == t.data("menu") && a(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-toggle-right").addClass("ft-toggle-left"),
                this.transit((function () {
                    ...
                    "vertical-content-menu" == t.data("menu") && this.manualScroller.disable(),
                        "horizontal-menu" == t.data("menu") && t.hasClass("vertical-overlay-menu") && a(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
                        "vertical-menu" != t.data("menu") && "vertical-menu-modern" != t.data("menu") || !a(".main-menu").hasClass("menu-fixed") || (a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height()),
        ...
        toOverlayMenu: function (e, n) {
            var i = t.data("menu");
            "vertical-menu-modern" == n ? "md" == e || "sm" == e || "xs" == e ? t.hasClass(i) && t.removeClass(i).addClass("vertical-overlay-menu") : t.hasClass("vertical-overlay-menu") && t.removeClass("vertical-overlay-menu").addClass(i) : "sm" == e || "xs" == e ? (t.hasClass(i) && t.removeClass(i).addClass("vertical-overlay-menu"),
                "vertical-content-menu" == i && a(".main-menu").addClass("menu-fixed")) : (t.hasClass("vertical-overlay-menu") && t.removeClass("vertical-overlay-menu").addClass(i),
                    "vertical-content-menu" == i && a(".main-menu").removeClass("menu-fixed"))
        },
        changeMenu: function (e) {
            a('div[data-menu="menu-wrapper"]').html(""),
                a('div[data-menu="menu-wrapper"]').html(s);
            var n = a('div[data-menu="menu-wrapper"]')
                , i = (a('div[data-menu="menu-container"]'),
            ...
            "xl" === e ? (t.removeClass("vertical-layout vertical-overlay-menu fixed-navbar").addClass(t.data("menu")),
                ...
                a("a.dropdown-item.nav-has-parent").on("click", (function () {
                ...
                ))) : (t.removeClass(t.data("menu")).addClass("vertical-layout vertical-overlay-menu fixed-navbar"),
                    ...
                    r.each((function (e, n) {
                        ...
                        t.is("h6") && (i = t.html(),
                            t.remove(),
                            a(n).prepend('<a href="#">' + i + "</a>").addClass("has-sub mega-menu-title"))
                    }
                    )),
        ...
        a.app.nav = {
            ...
            detectIE: function (n) {
                var a = e.navigator.userAgent
                    , t = a.indexOf("MSIE ");
                if (t > 0)
                    return parseInt(a.substring(t + 5, a.indexOf(".", t)), 10);
            ...
            bind_events: function () {
                ...
                a(".navigation-main").on("mouseenter.app.menu", "li", (function () {
                    var n = a(this);
                    if (a(".hover", ".navigation-main").removeClass("hover"),
                        t.hasClass("menu-collapsed") && "vertical-menu-modern" != t.data("menu") || "vertical-compact-menu" == t.data("menu") && !t.hasClass("vertical-overlay-menu")) {
                        ...
                        if (n.hasClass("has-sub") || (i = n.find("span.menu-title").text(),
                            s = n.children("a").attr("href"),
                            "" !== i && ((l = a("<a>")).attr("href", s),
                                l.attr("title", i),
                                l.text(i),
                                l.addClass("menu-title"))),
                            o = n.css("border-top") ? n.position().top + parseInt(n.css("border-top"), 10) : n.position().top,
                            t.hasClass("material-vertical-layout") && (o = a(".user-profile").height() + n.position().top),
                            !1 !== e.detectIE() && t.hasClass("material-vertical-layout") && (o = a(".user-profile").height() + n.position().top + a(".header-navbar").height()),
                            "vertical-compact-menu" !== t.data("menu") && l.appendTo(".main-menu-content").css({
                                position: "fixed",
                                top: o
                            }),
                    ...
                    a(".navbar-header, .main-menu").on("mouseenter", (function () {
                        if ("vertical-menu-modern" == t.data("menu") && (a(".main-menu, .navbar-header").addClass("expanded"),
                        ...
                        t.hasClass("menu-collapsed") && "vertical-menu-modern" == t.data("menu") && setTimeout((function () {
                            if (0 === a(".main-menu:hover").length && 0 === a(".navbar-header:hover").length && (a(".main-menu, .navbar-header").removeClass("expanded"),
                    ...
                    a(".main-menu-content").on("mouseleave", (function () {
                        (t.hasClass("menu-collapsed") || "vertical-compact-menu" == t.data("menu")) && (a(".main-menu-content").children("span.menu-title").remove(),
                            a(".main-menu-content").children("a.menu-title").remove(),
                            a(".main-menu-content").children("ul.menu-content").remove()),
                    ...
                    a("ul.menu-content").on("click", "li", (function (n) {
                        ...
                        if (t.is(".disabled"))
                            ...
                            t.is(".active") || (t.siblings(".active").trigger("deactive.app.menu"),
            ...
            adjustSubmenu: function (e) {
                var n, s, o, l, r, d = e.children("ul:first"), m = d.clone(!0);
                if (a(".main-menu-header").height(),
                    n = e.position().top,
                    o = i.height() - a(".header-navbar").height(),
                    r = 0,
                    d.height(),
                    parseInt(e.css("border-top"), 10) > 0 && (r = parseInt(e.css("border-top"), 10)),
                    l = o - n - e.height() - 30,
                    a(".main-menu").hasClass("menu-dark") ? "light" : "dark",
                    "vertical-compact-menu" === t.data("menu") ? (s = n + r,
                        l = o - n - 30) : "vertical-content-menu" === t.data("menu") ? (s = n + e.height() + r - 5,
                            l = o - a(".content-header").height() - e.height() - n - 60,
                            t.hasClass("material-vertical-layout") && (s = n + e.height() + a(".user-profile").height() + r)) : s = t.hasClass("material-vertical-layout") ? n + e.height() + a(".user-profile").height() + r : n + e.height() + r,
                    !1 !== this.detectIE() && t.hasClass("material-vertical-layout") && (s = n + e.height() + a(".user-profile").height() + r + a(".header-navbar").height()),
