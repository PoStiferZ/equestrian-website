                ...
                if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
                    ...
                    if (a("ul.search-list li").remove(),
                        ...
                        var t = ""
                            ...
                            , i = ""
                            , o = 0;
                        a.getJSON("../../../app-assets/data/" + c + ".json", (function (e) {
                            for (var l = 0; l < e.listItems.length; l++)
                                (0 == e.listItems[l].name.toLowerCase().indexOf(n) && o < 10 || 0 != e.listItems[l].name.toLowerCase().indexOf(n) && e.listItems[l].name.toLowerCase().indexOf(n) > -1 && o < 10) && (t += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === o ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e.listItems[l].url + '><div class="d-flex justify-content-start"><span class="mr-75 ' + e.listItems[l].icon + '"></span><span>' + e.listItems[l].name + "</span></div>",
                                    o++);
                            "" == t && "" == s && (s = '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100"><div class="d-flex justify-content-start"><span class="mr-75"></span><span>No results found.</span></div></a></li>'),
                                i = t.concat(s),
                                a("ul.search-list").html(i)
                        }
                        ))
                    } else
                        a(".app-content").hasClass("show-overlay") && a(".app-content").removeClass("show-overlay")
