    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Table Contact</h3>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="td-p1-nom "><strong><?= $value['nom'] . " </strong> " . $value['prenom'] ?></p>
                                                            <p class="td-p1-nom"><?= $value['mail'] ?></p>
                                                        ...
                                                        <td>
                                                            <p class="td-p1-nom"><strong><?= $value['sujet'] . "</strong><br><br> " . $value['commentaire'] ?></p>
                                                        </td>
