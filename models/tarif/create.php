                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-card-center">Créer un tarif</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" method="POST" action="traitement.php" enctype="multipart/form-data">
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-user"></i>Informations</h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput2">Libelle</label>
                                                        <input type="text" id="projectinput2" class="form-control" placeholder="Libelle" name="libT">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput2">Prix Mensuelle</label>
                                                        <input type="text" id="projectinput2" class="form-control" placeholder="Prix Mensuelle" name="pM">
                                                    </div>
                                                </div>
                                            </div>
