                                    ...
                                    <div class="card-body">
                                        <form class="form" method="POST" action="traitement.php" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <input type="hidden" id="projectinput1" class="form-control" name="ID_Tarif" value="<?= $value['ID_Tarif'] ?>">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Libelle</label>
                                                            <input type="text" id="projectinput1" class="form-control" name="libT" value="<?= $value['libelleTarif'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Libelle</label>
                                                            <input type="text" id="projectinput1" class="form-control" name="pM" value="<?= $value['prixMois'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
