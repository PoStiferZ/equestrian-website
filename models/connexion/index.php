...
<body class="vertical-layout vertical-menu-modern 1-column   bg-lighten-2 blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
  <!-- BEGIN: Content-->
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1"><img src="../../app-assets/images/logo/lo2go.png" alt="branding logo" style="width: 10%;">Equestrian World</div>
                  </div>
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>Connexion</span></h6>
                </div>
                  ...
                  <div class="card-body pt-0">
                    <form class="form-horizontal" action="traitement.php" method="POST">
                      <fieldset class="form-group floating-label-form-group">
                        ...
                        <input type="text" class="form-control" id="user-name" placeholder="Votre email" name="email">
                      </fieldset>
