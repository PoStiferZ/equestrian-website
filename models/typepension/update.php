                                    ...
                                    <div class="card-body">
                                        <form class="form" method="POST" action="traitement.php" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <input type="hidden" id="projectinput1" class="form-control" name="id" value="<?= $value['ID_TP'] ?>">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Libelle</label>
                                                            <input type="text" id="projectinput1" class="form-control" name="ltp" value="<?= $value['libelle_TP'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
