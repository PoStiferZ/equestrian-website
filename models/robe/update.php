                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="projectinput1" class="form-control" name="ID_Robe" value="<?= $value['ID_Robe'] ?>">

                                                            <input type="text" id="projectinput1" class="form-control" name="libR" value="<?= $value['libelleRobe'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
